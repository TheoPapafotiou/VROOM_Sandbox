...
"""
tof1 = VL53L1X.VL53L1X(i2c_bus=8, i2c_address=0x29, tca9548a_num=1, tca9548a_addr=0x70)
tof2 = VL53L1X.VL53L1X(i2c_bus=8, i2c_address=0x29, tca9548a_num=2, tca9548a_addr=0x70)
