...
"""
tof1 = VL53L1X.VL53L1X(i2c_bus=1, i2c_address=0x29, tca9548a_num=0, tca9548a_addr=0x70)
tof2 = VL53L1X.VL53L1X(i2c_bus=1, i2c_address=0x29, tca9548a_num=1, tca9548a_addr=0x70)
tof3 = VL53L1X.VL53L1X(i2c_bus=1, i2c_address=0x29, tca9548a_num=7, tca9548a_addr=0x70)
tof4 = VL53L1X.VL53L1X(i2c_bus=1, i2c_address=0x29, tca9548a_num=3, tca9548a_addr=0x70)
tof1.open()
